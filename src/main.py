...
def main():
    ...
    # Reporting.generate_report(top_categories_from_country, f"Categorias mais Vendidas no {country_to_filter_top_categories}")
    ...
    # Reporting.generate_report(top_mens_footwear_customers_from_country, f"Principais Clientes de Calçados Masculinos na {country_to_filter_footwear_customers}")
    ...
    # Reporting.generate_report(top_discount_sellers_from_country, f"Vendedores que Mais Dão Descontos no {country_to_filter_top_discounts}")
    ...
    # Reporting.generate_report(sales_over_years, f"Vendas de {year_beginning} a {year_end}")
